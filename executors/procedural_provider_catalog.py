...
"""Curated v0.13 external-provider discovery hints.

These records are not runtime truth. Every executable third-party provider still
passes PROCEDURAL_GENERATOR_PROVIDER against the active Blender session. Unknown
extension/package licenses stay explicit rather than being inferred from Blender.
"""
...
_CATALOG = {
    "builtin_geometry_nodes": {"provider_id": "builtin_geometry_nodes", "provider_version": "5.1.x", "execution_type": "GEOMETRY_NODES", "blender_min": "5.1.0", "blender_max": "5.1.99", "supports_seed": True, "probe_required": True, "license": "BLENDER_RUNTIME", "role": "PRIMARY_RUNTIME_BACKEND"},
    ...
    "sapling_tree_gen": {"provider_id": "sapling_tree_gen", "provider_version": "extension", "execution_type": "BPY_OPERATOR", "blender_min": "4.2.0", "supports_seed": True, "probe_required": True, "license": "DISCOVER_AT_PROBE", "role": "OPTIONAL_TREE_BACKEND"},
    "ivygen": {"provider_id": "ivygen", "provider_version": "extension", "execution_type": "BPY_OPERATOR", "blender_min": "4.2.0", "supports_seed": True, "probe_required": True, "license": "DISCOVER_AT_PROBE", "role": "OPTIONAL_SURFACE_GROWTH_BACKEND"},
    "ant_landscape": {"provider_id": "ant_landscape", "provider_version": "extension", "execution_type": "BPY_OPERATOR", "blender_min": "4.2.0", "supports_seed": True, "probe_required": True, "license": "DISCOVER_AT_PROBE", "role": "OPTIONAL_TERRAIN_BACKEND"},
    "archimesh": {"provider_id": "archimesh", "provider_version": "extension", "execution_type": "BPY_OPERATOR", "blender_min": "4.2.0", "supports_seed": True, "probe_required": True, "license": "DISCOVER_AT_PROBE", "role": "OPTIONAL_ARCHITECTURAL_BLOCKOUT"},
    ...
    "engon_botaniq": {"provider_id": "engon_botaniq", "provider_version": "1.9.x", "execution_type": "BPY_OPERATOR", "blender_min": "4.2.0", "supports_seed": True, "probe_required": True, "license": "GPL-3.0-or-later code; asset-pack license separate", "role": "OPTIONAL_ASSET_SCATTER_BACKEND"},
